...
- Ask Mike only for copy approval, a strategic fork, or a ship/redraft/abandon decision. Decide ordinary engineering details from code and tests.
...
- The remaining hooks are advisory except the snapshot hand-edit safety gate. Do not add hooks unless Mike asks.
