...
export function ReferralGoalCard({ stats, frameless = false, className }: ReferralGoalCardProps) {
  const content = (
  ...
  return (
    <Card className={cn("border-2 border-primary mb-8 bg-brutal-pink", className)}>
      <CardHeader>
        ...
        <CardDescription className="text-foreground font-bold">
          Get at least 2 people to vote to help us reach R ≥ 1.3
        </CardDescription>
      </CardHeader>
