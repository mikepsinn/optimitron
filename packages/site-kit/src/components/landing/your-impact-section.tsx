...
import { StatCardGrid } from "@optimitron/neobrutalist-ui/ui/stat-card"

export default function YourImpactSection() {
  // Calculate values from impact ledger
  const livesSaved = IMPACT_PER_VOTE.lives.toFixed(1)
  const sufferingYears = (IMPACT_PER_VOTE.sufferingHours / HOURS_PER_YEAR.value).toFixed(0)
