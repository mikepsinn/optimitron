...
export default function CallToAction() {
  ...
  const allOptions = [
    ...
    ...(donateEnabled ? [{
      ...
      description: "501(c)(3). Every dollar to creating a world without disease.",
      color: "bg-background",
    ...
    }] : []),
    {
      ...
      description: "And watch everyone you've every loved slowly dissolve.",
      color: "bg-primary",
  ...
  return (
    <SectionContainer bgColor="foreground" borderPosition="bottom" padding="lg">
      <Container>
        ...
        <div className={`grid md:grid-cols-2 ${options.length >= 4 ? 'lg:grid-cols-4' : 'lg:grid-cols-3'} gap-6`}>
