...
export const NAV_ITEMS_MAP = {
  ...
  join: {
    ...
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["organization", "endorse", "partner", "coalition"],
  },
  employees: {
    id: "employees",
    ...
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["presidents", "leaders", "remind", "overdue"],
  },
  signatories: {
    id: "signatories",
    label: "Treaty Signatories",
    path: ROUTES.signatories,
    description: "See the humans and organizations that signed the 1% Treaty",
    emoji: "🏆",
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["signatories", "signers", "people", "organizations"],
  },
  search: {
    id: "search",
    label: "Search",
    path: ROUTES.search,
    description:
      "Find campaign pages, people who signed, and organizations that endorsed",
    emoji: "🔎",
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["search", "find", "people", "organizations", "pages"],
  },
  poster: {
    id: "poster",
    ...
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["poster", "flyer", "print", "referral code"],
  },
  doorToDoor: {
    id: "doorToDoor",
    label: "Go Door to Door",
    path: ROUTES.doorToDoor,
    description:
      "Print the YES sheet and register the neighbors the internet missed",
    emoji: "🚪",
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["door to door", "canvass", "neighbors", "print"],
  },
  // The War on Disease menu mirrors the original apps/optimitron variant menu.
  // Pages that still live only on optimitron.com link there until they are
  // ported to the campaign app.
  manageHumanity: {
    id: "manageHumanity",
    ...
    canonicalVariant: VARIANTS.WAR_ON_DISEASE,
    allowedVariants: [VARIANTS.WAR_ON_DISEASE],
    keywords: ["dashboard", "referrals", "share link"],
  },
  joke: {
    id: "joke",
    label: "The Joke",
  ...
  humanityVGovernmentCase: {
    ...
    emoji: "📜",
    isExternal: true,
    keywords: ["humanity v. government", "case", "lawsuit"],
  },
  treatyImpact: {
    id: "treatyImpact",
    ...
    emoji: "📊",
    isExternal: true,
    keywords: ["impact", "analysis", "1% treaty"],
  },
  courtOfHumanity: {
    id: "courtOfHumanity",
  ...
  optimitronMcp: {
    id: "optimitronMcp",
    label: "MCP",
    path: optimitronUrl("/mcp"),
    description: "Connect your AI agent to Optimitron.",
    emoji: "🔌",
    isExternal: true,
    keywords: ["mcp", "agents", "api"],
  },
  developers: {
    id: "developers",
    label: "Developers",
    path: optimitronUrl("/developers"),
    description: "Build on Optimitron.",
    emoji: "🛠️",
    isExternal: true,
    keywords: ["developers", "api", "open source"],
  },
  wishocracy: {
    id: "wishocracy",
  ...
  rightToTrySurvey: {
    ...
    allowedVariants: [VARIANTS.ACCELERATED_MEDICINE],
    keywords: [
      "Right to Trial survey",
      "patient access survey",
      "state support",
    ],
  },
  rightToTryEmailUpdates: {
