/**
 * Person display-name parts. The plaintiff forms collect first / middle / last
 * separately, while `Person.displayName` stores the joined string, so both
 * directions of that conversion live here and stay in sync.
 */
