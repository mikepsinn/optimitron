    ...
    inputSchema: {
      ...
      properties: {
        dateKey: {
          type: "string",
          description:
            "One local date in YYYY-MM-DD. Defaults to today except for an unbounded stored OVERDUE backlog. Do not combine with startDateKey or endDateKey.",
        },
        startDateKey: {
          type: "string",
          description:
    ...
    inputSchema: {
      ...
      properties: {
        ...
        compact: {
          type: "boolean",
          description:
            "Return trackingReminderId as id, plus globalVariableId, nOf1VariableId, dateKey, name, due, and status.",
        },
        includeCompleted: {
          type: "boolean",
          description:
