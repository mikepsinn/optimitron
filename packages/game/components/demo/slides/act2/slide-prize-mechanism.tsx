  ...
  return (
    <SlideBase act={2} className="text-emerald-400">
      <div className="flex flex-col items-center justify-center gap-6 max-w-7xl mx-auto">
        {/* Title */}
        <h1 className="font-pixel text-lg md:text-2xl text-emerald-400 text-center">
          HOW THE PRIZE WORKS
        </h1>
        ...
        <div className="w-full space-y-4">
          ...
          <div className="flex justify-center">
            <div className="font-pixel text-sm text-zinc-300 bg-zinc-900 border border-zinc-600 rounded px-4 py-2">
              YOU ($100)
            </div>
          </div>
          ...
          {/* Smart Contract */}
          <div className="flex justify-center">
            <div className="font-pixel text-xs text-amber-400 bg-amber-500/10 border border-amber-500/40 rounded px-4 py-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-emerald-500/5 border-2 border-emerald-500/30 rounded-lg p-4 space-y-3 shadow-lg shadow-emerald-500/5">
              <div className="font-pixel text-xs text-emerald-300 text-center">
                ❌ TARGETS MISSED
              </div>
              <div className="space-y-2">
                <div className="font-pixel text-xs text-zinc-400">
        ...
        {/* Bottom Line */}
        <p className="font-pixel text-xs md:text-sm text-emerald-300 text-center">
