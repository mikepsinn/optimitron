      ...
      <div className="flex flex-col items-center justify-center gap-5 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <div className="bg-red-500/10 border-2 border-red-500/30 rounded-lg p-5 space-y-3 opacity-70">
            ...
            <div className="space-y-2 font-terminal text-xs text-zinc-400">
          ...
          <div className="bg-emerald-500/15 border-2 border-emerald-500/50 rounded-lg p-5 space-y-3">
            <div className="font-pixel text-sm text-emerald-400 text-center">
              🧪 DECENTRALIZED FDA
            </div>
            <div className="space-y-2 font-terminal text-xs text-zinc-300">
              <div className="flex justify-between">
                <span>Cost per patient:</span>
        ...
        {/* Bottom line */}
        <div className="font-pixel text-sm md:text-base text-cyan-300 text-center mt-2">
