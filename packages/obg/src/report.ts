...
import { describeGrade, reportTimestamp } from '@optimitron/optimizer';
...
// describeGrade is imported from @optimitron/optimizer
...
export function generateBudgetReport(
  ...
  lines.push('');
  lines.push(
    `*Generated by \`@optimitron/obg\` on ${reportTimestamp()} · ` +
    `${analysis.jurisdictionName} FY${analysis.fiscalYear} · ` +
    `${analysis.categories.length} categories · Optimal Budget Generator*`,
  );
