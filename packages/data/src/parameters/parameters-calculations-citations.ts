...
export const CURRENT_DISEASE_PATIENTS_GLOBAL: Parameter = {
  ...
  manualPageUrl: "https://manual.WarOnDisease.org/knowledge/strategy/questions.html",
  manualPageTitle: "The 20 Questions",
};
