...
- Objective: estimate useful spending levels for each discretionary spending predictor.
- `Suggested Level` uses support-constrained targets, so it stays in data-backed ranges.
- `MED` is the minimum useful level where gains first become consistent.
- `Slowdown Knee` is where extra spending starts showing weaker gains.

## Quick Optimal Levels
...
- Predictor: `predictor.derived.education_expenditure_per_capita_ppp`
- Unit: international $/person
- Mission KPIs configured: 1
- Note: Direct KPI currently uses primary completion rates; add learning-score KPIs when available.
- Ranges in this section: MED 43.782 to 43.782 international $/person; slowdown knee 69.668 to 69.668 international $/person; suggested level 2362.1 to 2362.1 international $/person.
- Additional non-primary outcome studies available: 5 (see linked pair pages).

### Primary KPI Rows

| KPI | Role | Suggested Level | MED | Slowdown Knee | Confidence | Data Status | Pair Report |
|-----|------|----------------:|----:|--------------:|-----------:|-------------|------------|
| Primary School Completion Rate | mission KPI | 2362.1 international $/person (data-backed level) | 43.782 international $/person | 69.668 international $/person | 0.703 (medium confidence) | enough data | [pair-predictor.derived.education_expenditure_per_capita_ppp__outcome.wb.primary_completion_rate_pct.md](pair-predictor.derived.education_expenditure_per_capita_ppp__outcome.wb.primary_completion_rate_pct.md) |

## Education Share of Government Spending

- Predictor: `predictor.derived.education_share_of_gov_expenditure_pct`
- Unit: % of government expenditure
- Mission KPIs configured: 1
- Note: Direct KPI currently uses primary completion rates; add learning-score KPIs when available.
- Ranges in this section: MED 12.034 to 12.034 % of government expenditure; slowdown knee 13.672 to 13.672 % of government expenditure; suggested level 13.672 to 13.672 % of government expenditure.
- Additional non-primary outcome studies available: 5 (see linked pair pages).
...
| KPI | Role | Suggested Level | MED | Slowdown Knee | Confidence | Data Status | Pair Report |
|-----|------|----------------:|----:|--------------:|-----------:|-------------|------------|
| Primary School Completion Rate | mission KPI | 13.672 % of government expenditure (data-backed level) | 12.034 % of government expenditure | 13.672 % of government expenditure | 0.651 (medium confidence) | enough data | [pair-predictor.derived.education_share_of_gov_expenditure_pct__outcome.wb.primary_completion_rate_pct.md](pair-predictor.derived.education_share_of_gov_expenditure_pct__outcome.wb.primary_completion_rate_pct.md) |

## Government Expenditure Per Capita (PPP)
...
- Predictor: `predictor.derived.gov_health_expenditure_per_capita_ppp`
- Unit: international $/person
- Mission KPIs configured: 1
- Ranges in this section: MED 16.917 to 16.917 international $/person; slowdown knee 28.924 to 28.924 international $/person; suggested level 2778.5 to 2778.5 international $/person.
- Additional non-primary outcome studies available: 5 (see linked pair pages).
...
- Predictor: `predictor.derived.gov_health_share_of_gov_expenditure_pct`
- Unit: % of government expenditure
- Mission KPIs configured: 1
- Ranges in this section: MED 6.559 to 6.559 % of government expenditure; slowdown knee 10.748 to 10.748 % of government expenditure; suggested level 27.789 to 27.789 % of government expenditure.
- Additional non-primary outcome studies available: 5 (see linked pair pages).
...
- Predictor: `predictor.derived.military_expenditure_per_capita_ppp`
- Unit: international $/person
- Mission KPIs configured: 1
- Note: Direct KPI currently uses battle-related deaths; add foreign-attack/security KPIs when available.
- Ranges in this section: MED N/A; slowdown knee 134.72 to 134.72 international $/person; suggested level N/A.
- Additional non-primary outcome studies available: 5 (see linked pair pages).
...
| KPI | Role | Suggested Level | MED | Slowdown Knee | Confidence | Data Status | Pair Report |
|-----|------|----------------:|----:|--------------:|-----------:|-------------|------------|
| Battle-Related Deaths | mission KPI | N/A | N/A | 134.72 international $/person | 0.472 (lower confidence) | not enough data | [pair-predictor.derived.military_expenditure_per_capita_ppp__outcome.wb.battle_related_deaths.md](pair-predictor.derived.military_expenditure_per_capita_ppp__outcome.wb.battle_related_deaths.md) |

## Military Share of Government Spending

- Predictor: `predictor.derived.military_share_of_gov_expenditure_pct`
- Unit: % of government expenditure
- Mission KPIs configured: 1
- Note: Direct KPI currently uses battle-related deaths; add foreign-attack/security KPIs when available.
- Ranges in this section: MED 6.972 to 6.972 % of government expenditure; slowdown knee 8.746 to 8.746 % of government expenditure; suggested level N/A.
- Additional non-primary outcome studies available: 5 (see linked pair pages).
...
| KPI | Role | Suggested Level | MED | Slowdown Knee | Confidence | Data Status | Pair Report |
|-----|------|----------------:|----:|--------------:|-----------:|-------------|------------|
| Battle-Related Deaths | mission KPI | N/A | 6.972 % of government expenditure | 8.746 % of government expenditure | 0.490 (lower confidence) | not enough data | [pair-predictor.derived.military_share_of_gov_expenditure_pct__outcome.wb.battle_related_deaths.md](pair-predictor.derived.military_share_of_gov_expenditure_pct__outcome.wb.battle_related_deaths.md) |
...
- Predictor: `predictor.derived.rd_share_of_gov_expenditure_pct`
- Unit: % of government expenditure
- Mission KPIs configured: 2
- Ranges in this section: MED 3.602 to 3.602 % of government expenditure; slowdown knee 1.498 to 4.917 % of government expenditure; suggested level 1.498 to 12.690 % of government expenditure.
- Additional non-primary outcome studies available: 4 (see linked pair pages).
