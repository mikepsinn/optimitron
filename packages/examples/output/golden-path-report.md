# 🏥 Optimitron — Golden Path Health Optimization Report
...
This report demonstrates the complete Optimitron causal analysis pipeline.
...
*Generated by `@optimitron/examples` golden path demo using `@optimitron/optimizer`.*