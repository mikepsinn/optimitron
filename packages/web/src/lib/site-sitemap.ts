...
const STATIC_SITEMAP_ROUTES: SiteSitemapRoute[] = [
  ...
  {
    path: ROUTES.humanityManagementTraining,
    priority: 0.7,
    changeFrequency: "monthly",
  },
  { path: "/survey", priority: 0.95, changeFrequency: "weekly" },
  { path: "/organizations", priority: 0.75, changeFrequency: "weekly" },
  { path: "/why", priority: 0.85, changeFrequency: "monthly" },
  { path: "/legal", priority: 0.6, changeFrequency: "monthly" },
  { path: "/impact", priority: 0.75, changeFrequency: "weekly" },
  { path: "/endorse", priority: 0.7, changeFrequency: "weekly" },
  { path: "/coalition", priority: 0.65, changeFrequency: "weekly" },
  { path: "/people", priority: 0.65, changeFrequency: "weekly" },
