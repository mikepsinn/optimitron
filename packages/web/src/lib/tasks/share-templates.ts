...
export const SHARE_TEMPLATES: ShareTemplate[] = [
  ...
  },
  {
    ...
    body: [
      ...
      ``,
      "Small note for the agenda: the treaty trades 1% of military spending for {trial_capacity_multiplier}× more clinical trials. That compresses disease eradication from {eradication_years_status_quo} years to {eradication_years_treaty}. Mathematically it reduces the arsenal's capacity from 122 apocalypses to 120.8 — and, just to be clear, you can only have one apocalypse. (Humanity has 12,241 warheads, nuclear winter takes ~100, the other 12,141 are decorative.) The 121 spare apocalypses will not be missed.",
      ``,
  ...
  },
  {
    ...
    requiredTokens: ["target_name"],
    body:
      "{target_name} — your employees spend $2.72 trillion a year on their capacity for organized violence, which is enough to buy 850 bullets for every man, woman, and child every year, even though it would require at most 2 bullets per person to murder everyone. After the 1% Treaty cut they would still have $2.69 trillion — enough to murder everyone 20 times, which should be more than sufficient. Sign: {treaty_url}",
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      `   • Reduces the arsenal's capacity: 122 apocalypses → 120.8`,
  ...
  },
  {
    ...
    body: [
      ...
      `Location: {treaty_url}`,
      ``,
      `Description: Reduces the arsenal's capacity from 122 apocalypses to 120.8. Unlocks {trial_capacity_multiplier}× clinical trial capacity. Disease eradication compressed from {eradication_years_status_quo} years to {eradication_years_treaty}.`,
      ``,
      `Agenda:`,
      `1. Type name`,
      `2. Click submit`,
  ...
  },
  {
    ...
    body: [
      `hey {target_name} 👋`,
      ``,
      `quick one — did you sign the treaty yet? the 1% one, reduces the arsenal's capacity from 122 apocalypses to 120.8 in exchange for {trial_capacity_multiplier}× the clinical trials. {treaty_url}`,
      ``,
