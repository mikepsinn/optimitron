...
export const SHARE_TEMPLATES: ShareTemplate[] = [
  ...
  },
  {
    ...
    requiredTokens: ["leader_name", "country", "days_overdue", "deaths_from_delay"],
    body: [
      `Hi {leader_name}! 👋`,
      ``,
      ...
      `   {treaty_url}`,
      ``,
      `Your colleagues who have already completed this step:`,
      `   — {deaths_from_delay} of them (posthumously)`,
      ``,
  ...
  },
  {
    ...
    requiredTokens: ["leader_name", "citizen_name", "days_overdue", "deaths_from_delay"],
    body: [
      `📅 CALENDAR INVITE`,
      ``,
      ...
      ``,
      `Notes: {deaths_from_delay} have died since this meeting was first scheduled. Recurring daily until acknowledged.`,
    ].join("\n"),
  },
  {
    id: "pip",
  ...
  },
  {
    id: "slack-dm",
    label: "Slack DM",
    requiredTokens: ["leader_name", "days_overdue", "deaths_from_delay"],
    body: [
      `hey {leader_name} 👋`,
      ``,
      `quick one — did you get a chance to sign the treaty yet? {treaty_url}`,
      ``,
      `no worries if not, just following up since it's day {days_overdue} and {deaths_from_delay} people have died waiting since I last pinged`,
      ``,
