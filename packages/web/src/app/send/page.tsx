      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-10">
        <div className="border-4 border-primary bg-brutal-yellow p-5 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="mt-3 text-base font-bold leading-snug sm:text-lg">
            The "Optimize Earth Task" contains a subtask to "End War and Disease", which contains "Ratify
            the 1% Treaty" subtask, which currently contains one very small subtask for one
            human you know.
          </p>
        </div>
