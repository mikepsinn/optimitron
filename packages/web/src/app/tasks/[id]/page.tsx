...
function getDependencyEdgeLabel(edgeType: string, direction: "incoming" | "outgoing") {
...
function RelatedTaskCard({
  ...
  return (
    <li className="border border-foreground p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2 text-[11px] font-black uppercase tracking-[0.12em] text-muted-foreground">
