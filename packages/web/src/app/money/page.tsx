  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {problemStats.map((stat) => (
            <div
              key={stat.label}
              className={`border-4 border-black ${stat.color} p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]`}
            >
              ...
              <p className={`text-xs font-medium mt-3 leading-relaxed ${stat.detailColor}`}>
                {stat.detail}
              </p>
            </div>
          ))}
      ...
      <section className="mb-16">
        ...
        <div className="border-4 border-black bg-white p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-6">
          <p className="text-sm text-black/80 font-medium leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border-4 border-black bg-brutal-cyan p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="text-xs font-black uppercase text-black/50 mb-1">Not this</div>
            <div className="text-sm font-black text-black">An investment vehicle</div>
          </div>
          <div className="border-4 border-black bg-brutal-cyan p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="text-xs font-black uppercase text-black/50 mb-1">Not this</div>
            <div className="text-sm font-black text-black">A security or speculative asset</div>
          </div>
          <div className="border-4 border-black bg-brutal-yellow p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="text-xs font-black uppercase text-black/50 mb-1">This</div>
            <div className="text-sm font-black text-black">Money with built-in governance</div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <p className="text-sm font-medium text-black/60 mb-8 max-w-3xl">
          ...
          {mechanisms.map((mech, index) => (
            <div key={mech.title} className="flex gap-6">
              <div className="flex flex-col items-center">
                <div
                  className={`w-12 h-12 border-4 border-black ${mech.color} flex items-center justify-center text-2xl shrink-0`}
                >
                  {mech.icon}
                </div>
              ...
              <div
                className={`flex-1 border-4 border-black ${mech.color} p-6 mb-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]`}
              >
                <h3 className={`text-xl font-black uppercase ${mech.textColor}`}>
                  {mech.title}
                </h3>
                <p className={`mt-2 text-sm font-medium ${mech.subTextColor}`}>
                  {mech.description}
                </p>
        ...
        <div className="space-y-4">
          <div className="border-4 border-black bg-white p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-black uppercase text-black text-sm">You spend $WISH</h3>
          ...
          <div className="border-4 border-black bg-white p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-black uppercase text-black text-sm">Treasury splits funds</h3>
                <p className="text-sm text-black/60 font-medium mt-1">
          ...
          <div className="border-4 border-black bg-white p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-black uppercase text-black text-sm">Citizens choose priorities</h3>
                <p className="text-sm text-black/60 font-medium mt-1">
          ...
          <div className="border-4 border-black bg-brutal-yellow p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-black uppercase text-black text-sm">No politicians deciding. No lobbying. Just data.</h3>
