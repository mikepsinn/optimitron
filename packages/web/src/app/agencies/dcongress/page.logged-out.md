...
- Page title: dCongress — Direct Democracy | Optimitron | International Campaign to End War and Disease
- Meta description: Congress has two jobs: set the budget and pass laws. Wishonia replaces both with direct citizen participation. No representatives required.
- Canonical: [missing]
...
- [📜REFERENDUMS Vote on proposals directly. Share the link. Skip the middleman who was going to ignore you anyway. REPLACES: CONGRESSIONAL LEGISLATION](/agencies/dcongress/referendums)
