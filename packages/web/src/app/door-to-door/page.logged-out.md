...
- Page title: Go Door to Door | International Campaign to End War and Disease
...
- Open Graph title: Go Door to Door
- Open Graph description: The referendum lives on the internet, but some presidents of Earth still answer the door instead. Print the YES sheet, read the twenty-second pitch, and register the neighbors the internet has not reached. Every scan of your code counts instantly — and credits you.
- Open Graph image: https://warondisease.org/api/og/route?path=%2Fdoor-to-door
- Twitter title: Go Door to Door
- Twitter description: The referendum lives on the internet, but some presidents of Earth still answer the door instead. Print the YES sheet, read the twenty-second pitch, and register the neighbors the internet has not reached. Every scan of your code counts instantly — and credits you.

## Visible Page Copy

## GO DOOR TO DOOR
- Print the YES sheet, knock, and read the pitch aloud. It takes twenty seconds. Neighbors with phones scan your code and their vote counts instantly — with referral credit to you. Neighbors without phones sign the paper. Photograph finished sheets and keep them; the campaign verifies each signer digitally.
- This prints the generic campaign URL. [Sign in](/auth/signin) to personalize the URL and QR code.
- PRINT
- COPY LINK
- [LETTER](/door-to-door)
- [A4](/door-to-door?paper=a4)
- INTERNATIONAL CAMPAIGN TO END WAR AND DISEASE
### VOTE YES ON THE 1% TREATY
- Paper edition of the treaty register — for humans the internet has not reached yet.
