...
const variantStyles = {
  ...
  yellow: {
    ...
    subtext: "text-brutal-yellow-foreground",
    stat: "border-primary text-brutal-yellow-foreground",
    statLabel: "text-brutal-yellow-foreground",
    btn: "bg-foreground text-background hover:bg-foreground/80",
    kicker: "text-brutal-yellow-foreground",
  },
  cyan: {
    bg: "bg-brutal-cyan",
    text: "text-brutal-cyan-foreground",
    subtext: "text-brutal-cyan-foreground",
    stat: "border-primary text-brutal-cyan-foreground",
    statLabel: "text-brutal-cyan-foreground",
    btn: "bg-foreground text-background hover:bg-foreground/80",
    kicker: "text-brutal-cyan-foreground",
  },
  dark: {
    bg: "bg-foreground",
      ...
      >
        ...
        <div className="flex flex-wrap gap-4 mb-5">
          <div className={`border-2 ${s.stat} px-3 py-1.5`}>
            ...
            <div className="text-sm font-black">~{fmtParam(PRIZE_POOL_HORIZON_MULTIPLE)} back</div>
          </div>
          <div className={`border-2 ${s.stat} px-3 py-1.5`}>
