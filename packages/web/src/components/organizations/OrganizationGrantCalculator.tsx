      ...
      <Dialog.Trigger asChild>
        <button
          ...
          className={cn(
            ...
            "min-h-5 h-5 w-5 p-0 text-[11px] leading-none",
          )}
          title={help}
          type="button"
        >
        ...
        <div className="border-t-2 border-foreground p-3 text-right">
          <Dialog.Close asChild>
            <button
              className={cn(
                defaultButtonClassName,
                "min-h-10 px-4 py-2 text-xs tracking-[0.12em]",
              )}
              type="button"
            >
              Got It
  ...
  return (
    <section className="border-2 border-foreground bg-background p-5">
      ...
      <p className="mt-3 text-sm font-bold leading-6 text-muted-foreground">
        Use this after you join: one email, one social post, and a website embed
        can turn your existing audience into verified responses to the{" "}
        {GLOBAL_SURVEY_NAME}. The estimate starts with the grant request and
        lives saved. Change the assumptions below if you need to.
      </p>
      ...
      <Accordion type="single" collapsible className="mt-5">
        ...
        >
          <Accordion.Header className="px-4 py-3 text-left text-sm font-black uppercase tracking-[0.12em] text-foreground">
            Show assumptions
          </Accordion.Header>
          <Accordion.Content
            unstyled
            className="space-y-5 border-t border-foreground p-4"
          >
            <div>
