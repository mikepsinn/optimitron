...
- **Publish verified copy.** After copy and screenshot checks, commit, push, and open or update a normal pull request. Pause only when Mike requests a hold or an unresolved strategic choice needs him.
