...
- **Publish verified copy.** Verify copy and screenshots. Commit the intended changes. Push the branch. Open or update a normal pull request. Pause only when Mike requests a hold or an unresolved strategic choice needs him.
