...
export const publicSiteAppRoutes = Object.freeze({
  warondisease: [
    ...
    {
      covers: ["apps/warondisease/app/door-to-door/page.tsx"],
      label: "Door-to-door canvassing guide",
    ...
    },
    {
      ...
      label: "Fix AI answers",
      routeName: "fix-ai",
      routePath: "/fix-ai",
      sourcePage: "apps/warondisease/app/fix-ai/page.tsx",
    },
    {
      covers: ["apps/warondisease/app/foundations/page.tsx"],
      label: "Foundations",
    ...
    {
      covers: ["apps/warondisease/app/signatories/page.tsx"],
