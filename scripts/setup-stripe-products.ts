 ...
 * Stripe account acct_1TPCJFD5epyB9qRx. In 2025 the links were generated
 * against a personal account and frozen into git, which routed donate buttons
 * on two sites to the wrong legal entity. Two guards prevent a recurrence:
 *
...
/**
 * The guard that keeps donations off personal accounts: refuse to write
 * anything unless the target account is registered as a nonprofit.
 */
