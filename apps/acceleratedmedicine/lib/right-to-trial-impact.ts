import {
  ...
  STATE_RTT_IMPLEMENTATION_COST_PER_DALY,
  STATE_RTT_IMPLEMENTATION_COST_PER_LIFE_SAVED,
...
/** Canonical central-scenario results with the paper's 90% intervals. */
export const RIGHT_TO_TRIAL_CANONICAL_RESULTS = {
  costPerDaly: STATE_RTT_IMPLEMENTATION_COST_PER_DALY,
  costPerLifeSaved: STATE_RTT_IMPLEMENTATION_COST_PER_LIFE_SAVED,
  livesSaved: STATE_RTT_TREATMENT_ACCELERATION_LIVES_SAVED,
  vsGiveWellPerLife: STATE_RTT_VS_GIVEWELL_COST_PER_LIFE_MULTIPLIER,
} as const;

export const RIGHT_TO_TRIAL_DOIS = [
  {
    label: "Right to Trial & FDA Upgrade Act (2025)",
    url: "https://doi.org/10.5281/zenodo.19076852",
  },
  {
    label: "Continuous Evidence Generation Protocol (2025)",
    url: "https://doi.org/10.5281/zenodo.18203375",
  },
] as const;
