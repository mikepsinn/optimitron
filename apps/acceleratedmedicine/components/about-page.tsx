      ...
      <SectionContainer bgColor="background" borderPosition="bottom" padding="lg">
        <Container>
          ...
          <p className="mt-7 max-w-4xl text-lg font-bold sm:text-xl md:text-2xl">
            We are a Wyoming 501(c)(3) nonprofit. We work so every patient can
            join a pragmatic clinical trial for a promising treatment, with a
            clinician, at a licensed center, and so every result is published.
          </p>
        </Container>
      </SectionContainer>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <Card className="rounded-none border-4 border-primary bg-background p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] sm:p-8">
              <p className="text-lg font-bold leading-relaxed">
                {NONPROFIT_FULL_LEGAL_NAME} is the legal home of the Right to
                Trial Initiative. The Institute for Accelerated Medicine is our
                registered DBA. We also operate as the International Campaign to
                End War and Disease.
              </p>
