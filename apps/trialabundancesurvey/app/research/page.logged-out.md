...
- Page title: Clinical Trial Evidence and Data Sources
- Meta description: Peer-reviewed evidence for pragmatic trials and the assumptions behind the Global Clinical Trial Abundance Survey's capacity model.
- Canonical: https://trialabundancesurvey.org/research
- Open Graph title: Clinical Trial Evidence and Data Sources
- Open Graph description: Peer-reviewed evidence for pragmatic trials and the assumptions behind the Global Clinical Trial Abundance Survey's capacity model.
- Open Graph image: [missing]
- Twitter title: Clinical Trial Evidence and Data Sources
- Twitter description: Peer-reviewed evidence for pragmatic trials and the assumptions behind the Global Clinical Trial Abundance Survey's capacity model.
