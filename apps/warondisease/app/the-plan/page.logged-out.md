...
- Canonical: https://warondisease.org/the-plan
...
- The target is 280 million verified humans. Here is the math, machinery, money, and sequence for getting there.
### THE PLAN IN 6 STEPS
...
- 280 MILLION
### TIME TO 280 MILLION
- START WITH ONE MILLION VERIFIED VOTERS. CHANGE ONLY R AND G.
- 😴
#### SLOW GROWTH
- R = 1.1, G = 7 days
- ~247 DAYS
- About 36 sharing rounds
- 🚀
#### STEADY GROWTH
- R = 1.3, G = 7 days
- ~119 DAYS
- About 17 sharing rounds
#### FAST GROWTH
- R = 1.6, G = 3 days
- ~33 DAYS
- About 11 sharing rounds
- 🔥
#### TWO FRIENDS
- R = 2, G = 3 days
- ~24 DAYS
- About 9 sharing rounds
- These are geometric illustrations, not forecasts. Real propagation loses people to overlap, failed verification, language, access, and the ancient human custom of seeing a useful link and thinking “I’ll do that later.”
### THE VOTE-TO-VOTE FUNNEL
- THE CHAIN ONLY GROWS WHEN EACH STEP MAKES THE NEXT STEP EASIER
#### SEE THE ASK
...
#### TELL TWO FRIENDS
- One voter becomes a path to the next two voters.
- THE LOOP
- VOTE → TELL TWO FRIENDS → HELP THEM VOTE → REPEAT
### WHAT WE WATCH
- FOUR NUMBERS TELL US WHETHER THE PLAN IS SPREADING OR MERELY LOOKING BUSY
- R > 1
- NEW VOTERS PER VOTER
- 3–7 days
...
- THE HUMAN LOOP AND THE POLITICAL LOOP HAVE TO CONNECT
#### THE VOTE LOOP
- → Make the treaty choice understandable in one screen.
...
#### THE POWER LOOP
- → Patient groups endorse and invite their members.
...
- [THE 1% TREATY Redirect 1% of global military spending into pragmatic clinical trials.](https://manual.warondisease.org/knowledge/solution/1-percent-treaty.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [DOES THE MATH WORK? The canonical impact paper. Trial capacity, timelines, benefits, costs, and sources.](https://manual.warondisease.org/knowledge/economics/1-pct-treaty-impact.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [GLOBAL REFERENDUM STRATEGY The evidence, limits, targets, and path from a public vote to treaty adoption.](https://manual.warondisease.org/knowledge/strategy/global-referendum.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
### VOTE & SHARE
- Patient groups start the chain. Every human who votes and tells two friends continues it. These are the field guides.
- [THE CALL SCRIPT A 22-question sequence that helps a loved one examine the case and vote in one call.](https://manual.warondisease.org/knowledge/strategy/call-script.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [REFERRAL & COMMUNICATIONS PLAN Who needs the message, what to say, and what a helpful advocate can do today.](https://manual.warondisease.org/knowledge/appendix/recruitment-and-propaganda-plan.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [TREATY FAQ & OBJECTIONS Common objections with sourced answers for the moment a conversation goes sideways.](https://manual.warondisease.org/knowledge/appendix/faq.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
### BUILD THE COALITION
- Organizations whose members need faster cures can endorse the treaty and invite their people to vote.
- [NONPROFIT COALITION STRATEGY Why disease organizations gain by working together, and how to invite another organization.](https://manual.warondisease.org/knowledge/strategy/nonprofit-coalition-strategy.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [LEGISLATION PACKAGE The treaty text, model legislation, and implementation language for advocates and legal staff.](https://manual.warondisease.org/knowledge/strategy/legislation-package.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [DECLARATION OF OPTIMIZATION The declaration organizations can sign to endorse the treaty publicly.](https://manual.warondisease.org/knowledge/strategy/declaration-of-optimization.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
### FUND THE PLAN
- The budget, prize, and 90-day pilot show what money buys and how anyone can check the result.
- [EARTH OPTIMIZATION PRIZE The prize mechanism and the rules for paying verified contributions when targets are met.](https://manual.warondisease.org/knowledge/strategy/earth-optimization-prize.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
- [CAMPAIGN BUDGET The line-item campaign cost across several propagation scenarios.](https://manual.warondisease.org/knowledge/economics/campaign-budget.html?utm_source=the_plan&utm_medium=web&utm_campaign=cross_site)
