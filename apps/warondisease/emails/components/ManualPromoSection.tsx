...
interface ManualPromoSectionProps {
  utmSource: string
  description?: string
}

export function ManualPromoSection({
  utmSource,
  description = "An alien who finds your species confusing wrote a step-by-step guide to not dying unnecessarily. It covers the economics, the legal bribes, and why nobody has to evolve morally.",
}: ManualPromoSectionProps) {
  return (
    <Section
      style={{
