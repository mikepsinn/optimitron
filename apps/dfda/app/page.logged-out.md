...
- [🧠ALZHEIMER'S 37M affected · 300 trials](/conditions/alzheimers-disease)
...
#### TOO SLOW
- Takes 14 years to bring a drug to market. People die waiting.
#### TOO EXCLUSIVE
- Only 14% of patients can participate. Strict eligibility criteria exclude most people.
#### TOO ARTIFICIAL
...
- Strict eligibility criteria (excludes 86.1%%+ of patients)
...
#### ADAPTABLE TRIAL
- NIH-funded pragmatic trial testing aspirin for heart disease prevention. Using EHR data from 15.1K+ patients across 40 sites.
...
- [YELLOW FEVER VACCINE (LIVE ATTENUATED) Treats 1 condition 14 trials · 100,000,000 participants VERY HIGH EFFECTIVENESS](/treatments/yellow-fever-vaccine-live-attenuated)
- [VACCINATIONS (INFLUENZA & PNEUMOCOCCAL) Treats 2 conditions 1,300 trials · 10,500,000 participants VERY HIGH EFFECTIVENESS](/treatments/vaccinations-influenza-and-pneumococcal)
- [MEASLES, MUMPS, AND RUBELLA (MMR) VACCINE Treats 1 condition 69 trials · 10,000,000 participants VERY HIGH EFFECTIVENESS](/treatments/measles-mumps-and-rubella-mmr-vaccine)
...
- [PERSONAL HEALTH STUDIES Track health outcomes and discover hidden patterns. 7,000+ crowdsourced studies on the causes and effects of foods, drugs, and supplements.](https://studies.dfda.earth)
- [COST-BENEFIT ANALYSIS Interactive analysis showing how pragmatic trials could reduce drug development from $41K to $929 per patient and save 10.7 billion lives.](https://impact.dfda.earth)
- [PROTOCOL SPECIFICATION The two-stage methodology: observational signal detection from real-world patient data, then pragmatic trial confirmation at 44x lower cost.](https://spec.dfda.earth)
### THE SCIENCE IS PROVEN. THE SOLUTION EXISTS.
- All we need is the will to transcend our primitive evolutionary past and devote 1% less to killing people and more to curing them.
- [ANSWER THE QUESTION](https://warondisease.org/#vote)
