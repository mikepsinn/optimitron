...
/**
 * Serif black-on-white OG image renderer, ported from the monolith's
 * `lib/black-white-text-og-image-response.tsx`. Requires the Libre
 * Baskerville font files in `public/fonts/`.
 */
