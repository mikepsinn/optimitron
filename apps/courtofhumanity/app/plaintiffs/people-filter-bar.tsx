...
const selectClassName =
  "min-h-11 w-full border-2 border-foreground bg-background px-3 font-bold text-foreground"
  ...
  return (
    <section className="flex justify-end text-card-foreground">
      <details
        ...
        open={isOpen}
      >
        <summary className="ml-auto inline-flex min-h-10 cursor-pointer list-none items-center gap-2 border-2 border-foreground bg-background px-3 text-xs font-black uppercase tracking-[0.14em] text-foreground hover:bg-muted [&::-webkit-details-marker]:hidden">
        ...
        <div className="mt-3 space-y-4 border-2 border-foreground bg-background p-4 sm:absolute sm:right-0 sm:z-20 sm:w-[min(44rem,calc(100vw-2rem))]">
