...
export const ALIGNMENT_BENCHMARKS: AlignmentBenchmarkProfile[] = [
  {
    ...
    allocations: {
      ...
      CYBERSECURITY: 3,
      DRUG_WAR: 4,
      ICE_CRIMINAL_DEPORTATION: 2,
      ICE_NONCRIMINAL_DEPORTATION: 3,
      FARM_SUBSIDIES_AGRIBUSINESS: 6,
      FOSSIL_FUEL_SUBSIDIES: 4,
      NUCLEAR_WEAPONS_MODERNIZATION: 4,
      VIOLENT_CRIME_INCARCERATION: 5,
      ...
      HUMANITARIAN_FOREIGN_AID: 3,
      VETERANS_HEALTHCARE: 3,
      NASA_SCIENCE_RESEARCH: 2,
      CLEAN_ENERGY_RD: 2,
