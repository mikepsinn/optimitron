...
export const SEGMENTS = [
  ...
  },
  {
    ...
    bgColor: "foreground",
    tags: ["hook", "problem"],
    narration: `Your governments currently spend ${milToTrialRatio} dollars preparing for and waging war for every one dollar they spend testing which medicines work. Your chance of dying from terrorism: one in thirty million. Your chance of dying from disease: one hundred percent.`,
  },
  ...
  },
  {
    ...
    narration: `Every politician ranked by the ratio they voted for: waging war versus testing medicines. A single number. Public. Immutable. On-chain. Your leaders are not evil. They are just optimising for the wrong metric. We changed the metric.`,
  },
  {
