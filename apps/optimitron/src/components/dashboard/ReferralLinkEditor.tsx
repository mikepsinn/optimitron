...
export function ReferralLinkEditor({
  ...
  title = null,
  description =
    "Your referral link. Issue it to everyone you do not want to suffer and die of horrible diseases. It will significantly reduce the probability that they will suffer and die from horrible diseases.",
  variant = "default",
  className,
