...
import { policyEvidenceLabel } from "@/lib/policy-presentation";
import type { PolicySample } from "./landing-data";
import { Tile, landingLinkClass } from "./LandingSection";
...
export function PolicyGeneratorTile({
  ...
  return (
    <Tile note={`United States · ${total} policies`} title="Optimal Policy Generator">
      <div aria-live="polite" className="flex flex-1 flex-col" key={policy.name}>
        ...
        <div className="mt-4 flex flex-col gap-2 text-sm">
          <p className="grid grid-cols-[9rem_1fr] gap-4">
            ...
            <span className="font-bold">{policyEvidenceLabel(policy.evidenceKind)}</span>
          </p>
          <p className="grid grid-cols-[9rem_1fr] gap-4">
