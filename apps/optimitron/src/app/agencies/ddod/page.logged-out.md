...
- [310 million](https://manual.WarOnDisease.org/knowledge/problem/cost-of-war.html)
...
- [$170 trillion](https://manual.WarOnDisease.org/knowledge/problem/cost-of-war.html)
- Adjusted for inflation. Enough to have cured every major disease several times over.
- [0.600](https://manual.WarOnDisease.org/knowledge/economics/1-pct-treaty-impact.html)
- Every dollar on military generates [0.600](https://manual.WarOnDisease.org/knowledge/economics/1-pct-treaty-impact.html) in economic output. Healthcare generates [4.30](https://manual.WarOnDisease.org/knowledge/economics/1-pct-treaty-impact.html). You are choosing the worse investment by a factor of 7.
### WHAT THAT MONEY COULD BUY INSTEAD
- Every year, your species takes [$2.72 trillion](https://manual.WarOnDisease.org/knowledge/economics/1-pct-treaty-impact.html) — the accumulated productive output of hundreds of millions of workers — and converts it into things designed to destroy other things. Here is a partial list of what you could do with it if you simply... stopped.
...
- [$60.0 billion](https://manual.WarOnDisease.org/knowledge/economics/1-pct-treaty-impact.html)
...
- [SEE THE OPTIMAL BUDGET](/obg)
- [STOP PRINTING WAR MONEY](/agencies/dtreasury/dfed)
