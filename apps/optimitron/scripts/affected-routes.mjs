 ...
 * - only page.tsx files under apps/optimitron/src/app become routes;
 ...
 *
 * Usage:
 *   node apps/optimitron/scripts/affected-routes.mjs
 *   node apps/optimitron/scripts/affected-routes.mjs apps/optimitron/src/app/treaty/page.tsx
 *   pnpm --filter @optimitron/web copy:preview -- --routes=$(node apps/optimitron/scripts/affected-routes.mjs ...)
 */
...
function toAbsolutePath(filePath) {
  ...
  if (normalizedInput.startsWith("apps/optimitron/")) {
