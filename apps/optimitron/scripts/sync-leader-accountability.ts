 ...
 *
 * Usage:
 *   npx tsx apps/optimitron/scripts/sync-leader-accountability.ts --import-db
 *   npx tsx apps/optimitron/scripts/sync-leader-accountability.ts --import-db --country-codes=US,RU
 *   npx tsx apps/optimitron/scripts/sync-leader-accountability.ts --print-json
 */
