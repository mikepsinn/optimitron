...
**Option A preview (Task Notification):**
...
Buttons: **[ Assign the task ]** ・ **[ Send the nice one ]**
...
>
> [ COMPLETE TASK → warondisease.org ]
...
#### A1-TASK (Task Notification format)
