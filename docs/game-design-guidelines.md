...
**Reference implementation:** `apps/optimitron/src/components/demo/` and
`apps/optimitron/src/components/demo/slides/sierra/`.
...
**Source:** `apps/optimitron/src/lib/demo/palette.ts`, `apps/optimitron/src/styles/sierra.css`
...
**Source:** `apps/optimitron/src/app/layout.tsx`
...
**Source:** `apps/optimitron/src/styles/sierra.css`
...
**Source:** `apps/optimitron/src/components/demo/animations/sierra/`
...
**Source:** `apps/optimitron/src/components/demo/SierraChrome.tsx`
...
**Source:** `apps/optimitron/src/lib/wish-sound.ts`, `apps/optimitron/src/lib/demo-tts.ts`
...
**Source:** `apps/optimitron/src/lib/demo-script.ts`
...
| File | Contents |
|------|----------|
| `apps/optimitron/src/styles/sierra.css` | Complete CSS effects library — palettes, fonts, CRT effects, pixel borders, animations, and UI chrome styles |
| `apps/optimitron/src/lib/demo/palette.ts` | EGA/VGA color palettes with semantic mappings |
| `apps/optimitron/src/lib/wish-sound.ts` | Web Audio API sound effect presets and fanfares |
| `apps/optimitron/src/lib/demo-script.ts` | Wishonia narration, segment copy, and playlist structure |
| `apps/optimitron/src/app/layout.tsx` | Font loading setup (Press Start 2P, VT323, DM Sans, Space Mono) |
| `apps/optimitron/src/components/demo/slides/GameTitleSlide.tsx` | Title-screen and intro-slide reference implementation |
| `apps/optimitron/src/components/demo/SierraChrome.tsx` | Full game HUD layout, inventory, narrator, and quest chrome |
| `apps/optimitron/src/components/demo/animations/sierra/glitch-text.tsx` | GlitchText component |
| `apps/optimitron/src/components/demo/animations/sierra/animated-counter.tsx` | AnimatedCounter component |
| `apps/optimitron/src/components/demo/animations/sierra/animated-bar-chart.tsx` | AnimatedBarChart component |
| `apps/optimitron/src/components/demo/animations/sierra/progress-ring.tsx` | ProgressRing component |
| `apps/optimitron/src/components/demo/animations/sierra/particle-emitter.tsx` | ParticleEmitter component |
| `apps/optimitron/src/components/demo/slides/sierra/SierraSlideWrapper.tsx` | Slide wrapper with act-based gradients + pixel grid overlay |
| `apps/optimitron/src/components/demo/SierraChrome.tsx` | Full game HUD layout |
| `apps/optimitron/src/components/demo/SierraGameContext.tsx` | Game state management (acts, score, inventory, quests) |
