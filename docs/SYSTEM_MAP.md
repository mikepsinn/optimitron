...
| Shared MCP primitives | `packages/mcp` | Resource/auth verification, result serialization and redacted audit helpers with injected persistence; no app imports. |
